...
module StreamFifo (
  ...
  assign io_pop_payload_isWrite = _zz_3[3];
  assign logic_ptrDif = (logic_pushPtr_value - logic_popPtr_value);
  assign io_occupancy = {(logic_risingOccupancy && logic_ptrMatch),logic_ptrDif};
  assign io_availability = {((! logic_risingOccupancy) && logic_ptrMatch),_zz_9};
  always @ (posedge debugCd_external_clk) begin
...
module DataCache (
  ...
  assign _zz_22 = (! stageB_flusher_counter[6]);
  ...
  assign _zz_24 = (stageB_mmuRsp_isIoAccess || stageB_isExternalLsrc);
  assign _zz_25 = (stageB_waysHit || (stageB_request_wr && (! stageB_request_isAmo)));
  assign _zz_26 = (! stageB_amo_internal_resultRegValid);
  assign _zz_27 = (stageB_request_isLrsc && (! stageB_lrSc_reserved));
  assign _zz_28 = ((loader_valid && io_mem_rsp_valid) && rspLast);
  assign _zz_29 = (stageB_request_isLrsc && (! stageB_lrSc_reserved));
  assign _zz_30 = (((! stageB_request_wr) || stageB_request_isAmo) && ((stageB_dataColisions & stageB_waysHits) != 2'b00));
  assign _zz_31 = (stageB_request_amoCtrl_alu | {stageB_request_amoCtrl_swap,2'b00});
  assign _zz_32 = ($signed(_zz_33) + $signed(_zz_37));
  assign _zz_33 = ($signed(_zz_34) + $signed(_zz_35));
  assign _zz_34 = io_cpu_writeBack_storeData[31 : 0];
  assign _zz_35 = (stageB_amo_compare ? (~ stageB_dataMux[31 : 0]) : stageB_dataMux[31 : 0]);
  assign _zz_36 = (stageB_amo_compare ? _zz_38 : _zz_39);
  assign _zz_37 = {{30{_zz_36[1]}}, _zz_36};
  assign _zz_38 = 2'b01;
  assign _zz_39 = 2'b00;
  assign _zz_40 = 1'b1;
  assign _zz_41 = loader_counter_willIncrement;
  assign _zz_42 = {3'd0, _zz_41};
  assign _zz_43 = {loader_waysAllocator,loader_waysAllocator[1]};
  assign _zz_44 = {tagsWriteCmd_payload_data_address,{tagsWriteCmd_payload_data_error,tagsWriteCmd_payload_data_valid}};
  assign _zz_45 = {tagsWriteCmd_payload_data_address,{tagsWriteCmd_payload_data_error,tagsWriteCmd_payload_data_valid}};
  always @ (posedge debugCd_external_clk) begin
    if(_zz_5) begin
  ...
  always @ (posedge debugCd_external_clk) begin
    if(_zz_4) begin
      ways_0_tags[tagsWriteCmd_payload_address] <= _zz_44;
    end
  end

  always @ (posedge debugCd_external_clk) begin
    if(_zz_7) begin
      _zz_20 <= ways_1_tags[tagsReadCmd_payload];
    end
  end

  always @ (posedge debugCd_external_clk) begin
    if(_zz_2) begin
      ways_1_tags[tagsWriteCmd_payload_address] <= _zz_45;
    end
  end
  ...
  assign _zz_13 = (io_cpu_memory_address[11 : 2] >>> 0);
  assign _zz_14 = dataWriteCmd_payload_mask[3 : 0];
  always @ (*) begin
    _zz_12[0] = (((dataWriteCmd_valid && dataWriteCmd_payload_way[0]) && (dataWriteCmd_payload_address == _zz_13)) && ((stageA_mask & _zz_14) != 4'b0000));
    _zz_12[1] = (((dataWriteCmd_valid && dataWriteCmd_payload_way[1]) && (dataWriteCmd_payload_address == _zz_13)) && ((stageA_mask & _zz_14) != 4'b0000));
  end

  assign stageA_dataColisions = (stage0_dataColisions_regNextWhen | _zz_12);
  always @ (*) begin
  ...
  assign stageB_amo_addSub = _zz_32;
  ...
  always @ (*) begin
    loader_counter_valueNext = (loader_counter_value + _zz_42);
  ...
  assign _zz_15 = (_zz_3 && 1'b1);
  assign _zz_16 = ((dataReadCmd_valid && (! io_cpu_memory_isStuck)) && 1'b1);
  assign _zz_17 = (_zz_1 && 1'b1);
  ...
  always @ (posedge debugCd_external_clk) begin
    if(systemCd_logic_outputReset) begin
      ...
      if((! loader_valid))begin
        loader_waysAllocator <= _zz_43[1:0];
      end
    end
  end
...
module InstructionCache (
  ...
  assign _zz_26 = (fetchStage_hit_wayId >>> 0);
  assign _zz_27 = {lineLoader_write_tag_0_payload_data_address,{lineLoader_write_tag_0_payload_data_error,lineLoader_write_tag_0_payload_data_valid}};
  assign _zz_28 = {lineLoader_write_tag_1_payload_data_address,{lineLoader_write_tag_1_payload_data_error,lineLoader_write_tag_1_payload_data_valid}};
  always @ (posedge debugCd_external_clk) begin
    if(_zz_2) begin
  ...
  always @ (posedge debugCd_external_clk) begin
    if(_zz_4) begin
      ways_0_tags[lineLoader_write_tag_0_payload_address] <= _zz_27;
    end
  end
  ...
  always @ (posedge debugCd_external_clk) begin
    if(_zz_3) begin
      ways_1_tags[lineLoader_write_tag_1_payload_address] <= _zz_28;
    end
  end
  ...
  assign fetchStage_read_waysValues_0_tag_valid = _zz_12[0];
  assign fetchStage_read_waysValues_0_tag_error = _zz_12[1];
  ...
  assign fetchStage_read_waysValues_1_tag_valid = _zz_15[0];
  assign fetchStage_read_waysValues_1_tag_error = _zz_15[1];
  ...
  assign fetchStage_hit_bankId = _zz_26;
